...
* **可选扩展插件**：Sentinel / Denizen 只用于后续护卫、战斗、脚本演出、钓鱼等扩展能力；未安装时不影响基础 AI 对话。
  * [Sentinel](https://www.spigotmc.org/resources/sentinel.22017/)：Citizens 的战斗 NPC 扩展，适合后续实现护主、打怪、守家等能力。Jenkins dev builds：[Sentinel Jenkins](https://ci.citizensnpcs.co/job/Sentinel/)。
  ...
  * 当前版本尚未接入 Sentinel / Denizen 行为服务；下载链接只是为后续扩展准备。
